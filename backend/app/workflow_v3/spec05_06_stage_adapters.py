...
def _produce_spec05(
    ...
    args = [
        ...
        "--capability-manifest",
        str(_required(parent, "template/template_capability_manifest.json")),
        "--metadata-config",
        ...
        str(_required(parent, "media/media_evidence_ledger.json")),
        "--media-representation-plan",
        str(_required(parent, "media/media_representation_plan.json")),
        "--asset-root",
        str(assets),
        "--source-pdf",
